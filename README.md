...
| Name           | Age      | Database                                                | Frontend                                                                                                            | Notes                                                                                                                                         |
| -------------- | -------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| as-finance     | Oct 2024 | JSON file                                               | N/A                                                                                                                 | scraper wrapping around [UCSD A.S. finance](https://finance.ucsd.edu/Home/ListFunded), analytics stored in JSON file                          |
| assassin       | Jan 2020 | [lowdb](https://github.com/typicode/lowdb) (JSON files) | [Elimination](https://orbiit.github.io/elimination/)                                                                | this is why the server exists; everything else is just co-opting the same server                                                              |
| assync         | Nov 2020 | MongoDB (local)                                         | [UGWA](https://orbiit.github.io/gunn-web-app/)                                                                      | assignment sync across devices                                                                                                                |
| colour         | Nov 2020 | N/A                                                     | N/A                                                                                                                 | color previewer                                                                                                                               |
| counter        | Jan 2020 | [lowdb](https://github.com/typicode/lowdb) (JSON file)  | [UGWA](https://orbiit.github.io/gunn-web-app/), [Yearbook signing](https://sheeptester.github.io/yearbook-signing/) | originally made for UGWA analytics, then co-opted for virtual yearbook                                                                        |
| errors         | Jan 2020 | N/A                                                     | N/A                                                                                                                 |                                                                                                                                               |
| free-food      | Feb 2026 | MongoDB (Atlas)                                         | [free food events at UCSD](https://sheeptester.github.io/ucsd-free-food/)                                           | proxy for accessing MongoDB; database is owned by hackathon partner                                                                           |
| interstud-comm | Nov 2020 | MongoDB (local)                                         | [UGWA](https://orbiit.github.io/gunn-web-app/)                                                                      | chat (fun fact, this feature is inspired by me seeing "interstudent communication" written as a feature for a rival Gunn app on a whiteboard) |
| note           | Jan 2020 | [lowdb](https://github.com/typicode/lowdb) (JSON file)  | N/A                                                                                                                 |                                                                                                                                               |
| sgy            | Nov 2020 | MongoDB (local)                                         | [Schoology dislikes](https://github.com/SheepTester/hello-world/blob/master/userscripts/sgy-dislike.user.js)        | [adds a dislike button](https://www.youtube.com/watch?v=TkNoMWBd3Xg) to Schoology updates                                                     |
